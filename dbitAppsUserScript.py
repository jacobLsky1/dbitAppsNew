...
for row in all_apps_records:
    ...
    if appLogger != "null":
        ...
        columns = (("date", "VARCHAR(255)"),("time", "VARCHAR(255)"), ("valid_status", "VARCHAR(255)"), ("device_type", "VARCHAR(255)"),
        ...
        for item in jsonList:
            ...
            ).format(tbl_name=sql.Identifier(name)),[date, time, status, devicetype, country_code, region_name, myip, useragent])
            num = num + 1
